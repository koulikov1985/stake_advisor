    ...
    <div className="dash">
      ...
      <header className="dash-header">
        ...
        <div className="dash-header-right">
          <a href="https://discord.gg/rBCt9yp7" target="_blank" rel="noopener noreferrer" className="dash-discord">
      ...
      <main className="dash-main">
                    ...
                    <button
                      ...
                      onClick={() => {
                        if ((affiliateStats?.total_earned || 0) >= 25) {
                          window.open('https://discord.gg/rBCt9yp7', '_blank');
                        }
                      }}
                    >
        ...
        <div className="dash-links">
          ...
          <a href="https://discord.gg/rBCt9yp7" target="_blank" rel="noopener noreferrer" className="quick-link">
